                ...
                <div class="col-4 offset-2">
                    <form method="POST" action="drregister.php">
                        <table>
                            ...
                            <tr> 
                                <td> <a href="drregister.php"><input type="button" name="register" style="background-color: rgba(17, 117, 211, 0.726);" ></a></td>
                            </tr>
                        </table> 
                    </form>
                </div>
                ...
                <div class="row">
                    ...
                    <form name="drUser" method="post" action="drlogin.php">
                        <table>
                            ...
                            <tr> 
                                <td> <button name="login" type="submit" style="background-color: rgba(17, 117, 211, 0.726);" >Login</button></td>
                            </tr>
                        </table>
                    </form>
                    </div>
